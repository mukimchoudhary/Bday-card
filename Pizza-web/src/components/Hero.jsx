  ...
  return (
    <div className=" h-screen bg-black text-white flex flex-col md:flex-row justify-center items-center md:gap-8">
      ...
      <div className=" w-full md:w-2/4 text-center md:text-start mt-16 space-y-4">
        ...
        Pizza is love baked into dough, a masterpiece in every slice. With every topping, it tells a story, a symphony of flavor that dances on your taste buds. It’s the comfort of home and the joy of sharing, wrapped in cheesy perfection.
